document.addEventListener('DOMContentLoaded',function(){const submitButton=document.getElementById('updateCourseSubmitButton');const form=document.getElementById('updateCourseForm');submitButton.addEventListener('click',function(){form.submit();});});;document.addEventListener('DOMContentLoaded',function(){const yearLevelMapping={'First Year':'first-year','Second Year':'second-year','Third Year':'third-year','Fourth Year':'fourth-year'};const semesterMapping={'1st Semester':'1st-semester','2nd Semester':'2nd-semester','3rd Semester':'3rd-semester'};document.querySelectorAll('.addFieldButton').forEach(button=>{button.addEventListener('click',function(){const yearLevelStr=this.getAttribute('data-year-level');const semesterStr=this.getAttribute('data-semester');if(!yearLevelStr||!semesterStr){console.error('Missing year level or semester attribute');return;}
