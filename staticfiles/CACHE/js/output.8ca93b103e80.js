...
const newRow=document.createElement('tr');newRow.classList.add('bg-white');newRow.innerHTML=`
        ...
        `;document.getElementById('courses-table-body').appendChild(newRow);attachRemoveEvent(newRow.querySelector('.removeFieldButton'));});});function attachRemoveEvent(button){button.addEventListener('click',function(){this.closest('tr').remove();});}
