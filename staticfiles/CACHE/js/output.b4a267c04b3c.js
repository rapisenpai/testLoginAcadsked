...
const newRow=document.createElement('tr');const rowNumber=table.querySelectorAll('tr').length+1;newRow.classList.add('course-field','bg-white');newRow.innerHTML=`
                    ...
                    <td>
                      <input type="text"  id="course-code-input-"   maxlength="10"  autocomplete="off" name="course_code" class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Course Code">
                    </td>
                    <td>
                    ...
                    <td>
                      <input type="number" id="lecture-input-"  id="" autocomplete="off" name="lecture" class="no-spinner py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Lecture" min="1" max="9">
                    </td>
                    <td>
