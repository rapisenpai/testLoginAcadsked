...
attachValidation();let isFormDirty=false;function setFormDirty(){isFormDirty=true;}
...
function attachValidation(){document.querySelectorAll('input[type="text"], input[type="number"], textarea').forEach(input=>{input.addEventListener('input',setFormDirty);input.addEventListener('change',setFormDirty);});}
