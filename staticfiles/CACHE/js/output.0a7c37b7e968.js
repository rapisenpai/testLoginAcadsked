...
const newField=document.createElement('div');newField.classList.add('course-field');newField.innerHTML=`
        ...
        `;container.insertBefore(newField,this);attachRemoveEvent(newField.querySelector('.removeFieldButton'));});});function attachRemoveEvent(button){button.addEventListener('click',function(){this.closest('tr').remove();});}
