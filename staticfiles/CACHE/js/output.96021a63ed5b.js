...
const newRow=document.createElement('tr');const rowNumber=table.querySelectorAll('tr').length+1;newRow.classList.add('course-field','bg-white');newRow.innerHTML=`
                    <td>
                    <input type="text" id="username" name="username" maxlength="1"><br><br>
                    ...
                    <td>
                      <input type="number"    autocomplete="off" name="lecture" class="no-spinner py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Lecture" maxlength="1">
                    </td>
                    <td>
                      <input type="number" autocomplete="off" name="laboratory" class="no-spinner py-2 px-3 block w-full border-gray-200 rounded-lg text-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Laboratory" maxlength="1">
                    </td>
                    <td>
                    <input type="hidden" name="course_id" value="">
                    <input type="hidden" name="semester" value="${semester}">
                    <input type="hidden"  maxlength="1"  name="year_level" value="${yearLevel}">
