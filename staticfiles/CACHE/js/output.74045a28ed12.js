...
function validateFormOnSubmit(event){let isValid=true;document.querySelectorAll('input').forEach(function(input){if(input.classList.contains('border-red-500')){isValid=false;}});if(!isValid){event.preventDefault();}}
