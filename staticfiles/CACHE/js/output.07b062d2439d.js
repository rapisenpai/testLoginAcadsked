document.addEventListener('DOMContentLoaded',function(){const selectedContainer=document.getElementById('selected-container');const placeholder=document.getElementById('placeholder');const searchInput=document.getElementById('search-input');const dropdownMenu=document.getElementById('dropdown-menu');const selectedItems=new Set();const options=[{'value':1,'text':'RAFHAEL LOWIX HOMWAD','profile':'/media/profile_image/110092024212639.jpg'},{'value':30,'text':'El Jan Nerie Alburo','profile':'/media/profile_image/default-avatar.jpg'},{'value':31,'text':'Reir Erlinda Cutad','profile':'/media/profile_image/default-avatar.jpg'},{'value':32,'text':'Jonilyn Dabalos','profile':'/media/profile_image/default-avatar.jpg'},{'value':33,'text':'IAN VAL DELOS REYES','profile':'/media/profile_image/default-avatar.jpg'},{'value':34,'text':'John Jefferson Dela Cruz','profile':'/media/profile_image/default-avatar.jpg'},{'value':35,'text':'Ariel Gamao','profile':'/media/profile_image/default-avatar.jpg'},{'value':36,'text':'Reban Cliff Fajardo','profile':'/media/profile_image/default-avatar.jpg'},{'value':37,'text':'LAARNI IBAÑEZ','profile':'/media/profile_image/default-avatar.jpg'},{'value':38,'text':'Christopher Anana','profile':'/media/profile_image/default-avatar.jpg'},{'value':39,'text':'Analyn Casipe','profile':'/media/profile_image/default-avatar.jpg'},{'value':40,'text':'RJ SUASIN','profile':'/media/profile_image/default-avatar.jpg'},{'value':41,'text':'Gertrude Tampus','profile':'/media/profile_image/default-avatar.jpg'},{'value':42,'text':'Jerson Viagedor','profile':'/media/profile_image/default-avatar.jpg'},{'value':43,'text':'ROGELIO MASANGKAY','profile':'/media/profile_image/default-avatar.jpg'},{'value':47,'text':'LHORELAI COSO','profile':'/media/profile_image/None10092024021717.jpg'},{'value':48,'text':'TEST TEST','profile':'/media/profile_image/None10092024022130.jpg'}];function updateOptions(query=''){const filteredOptions=options.filter(option=>option.text.toLowerCase().includes(query.toLowerCase()));dropdownMenu.innerHTML='';if(filteredOptions.length===0){const noResultsMessage=document.createElement('div');noResultsMessage.classList.add('py-2','px-4','w-full','text-sm','text-gray-600','text-center','no-results');noResultsMessage.textContent='No results found';dropdownMenu.appendChild(noResultsMessage);}else{filteredOptions.forEach(option=>createOptionElement(option));}
...
const debouncedUpdateOptions=debounce(updateOptions,300);searchInput.addEventListener('input',()=>{debouncedUpdateOptions(searchInput.value);});updateOptions();});;