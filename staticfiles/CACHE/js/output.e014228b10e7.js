...
function attachValidation(){document.querySelectorAll('[id^="laboratory-input-"]').forEach(function(input){input.addEventListener('input',function(){validateInput(this,0,9);});});document.querySelectorAll('[id^="lecture-input-"]').forEach(function(input){input.addEventListener('input',function(){validateInput(this,1,9);});});document.querySelectorAll('[id^="course-code-input-"]').forEach(function(input){input.addEventListener('input',function(){validateTe(this);});});document.querySelectorAll('[id^="course_description-input-"]').forEach(function(input){input.addEventListener('input',function(){validateInput(this);});});}
